	...
	<div class="container" style="background-color: lavender">
		<div class="jumbotron" style="background-color: lavender">
			<h1 style="text-align: center">
				<small> Stock de Producto Actualizado</small>
			</h1>
			<h1 style="text-align: center">
		...
		<div class="col-md-12" style="height: 300px">
			...
			<div class="col-md-8">
				<p>
					<a href="verStock" class="btn btn-primary btn-lg btn-block"> <span
						class="glyphicon glyphicon-th-list" aria-hidden="true"></span> Ver
						Stock
					</a> <a href="altaProducto" class="btn btn-primary btn-lg btn-block"><span
						class="glyphicon glyphicon-edit" aria-hidden="true"></span> Dar de
						Alta un Producto</a> <a href="irIndex"
						class="btn btn-primary btn-lg btn-block"><span
						class="glyphicon glyphicon-home" aria-hidden="true"></span> Volver
						a inicio</a>
				</p>
			</div>
			<div class="col-md-2"></div>
