...
public class Stock {
	...
	/**
	 * Devuelve un listado de los productos del stock, tengan o no stock, es
	 * decir, los productos con cantidad 0 son incluidos.<br>
	 * 
	 * @param producto
	 * @param cantidad
	 * @return
	...
	/**
	 * Devuelve un mapa con los productos y su stock correspondiente, tengan o
	 * no stock, es decir, los productos con cantidad 0 son incluidos.<br>
	 * 
	 * @param producto
	 * @param cantidad
	 * @return
	 ...
	 * @param producto
	 * @param cantidad
	 * @return true en caso de exito, false si el producto ya existe en el
	 *         stock.<br>
	 */
	...
	/**
	 * Permite agregar stock al existente para un producto dado. Si el producto
	 * tiene un stock de N, ahora tendra N + cantidad.<br>
	 * 
	 * @param producto
	 * @param cantidad
	 * @return true en caso de exito, false si el producto no existe en el
	 *         stock.<br>
	 */
	...
	/**
	 * Devuelve el stock disponible para el producto pedido. NULL si el producto
	 * no existe en el stock<br>
	 * 
	 * @param producto
	 * @return
	 */
	...
	/**
	 * Elimina el producto indicado del stock, no importa cual sea la cantidad
	 * disponible del mismo.<br>
	 * 
	 * @param producto
	 * @return true en caso de exito, false si el producto no existe en el
	 *         stock.<br>
