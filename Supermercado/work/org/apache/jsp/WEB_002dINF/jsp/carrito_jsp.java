...
public final class carrito_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  private boolean _jspx_meth_form_005fform_005f0(PageContext _jspx_page_context)
    ...
    // /WEB-INF/jsp/carrito.jsp(59,5) name = action type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_form_005fform_005f0.setAction("agregarProductoAlCarrito");
    // /WEB-INF/jsp/carrito.jsp(59,5) name = method type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_form_005fform_005f0.setMethod("POST");
    // /WEB-INF/jsp/carrito.jsp(59,5) null
    ...
    try {
      ...
      if (_jspx_eval_form_005fform_005f0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
        do {
          ...
          out.write("\t\t\t\t\t\t\t<button type=\"submit\" class=\"btn btn-info\" value=\"Agregar\">Agregar</button>\r\n");
          out.write("\t\t\t\t\t\t</div>\r\n");
          out.write("\t\t\t\t\t</div>\r\n");
          out.write("\t\t\t\t");
    ...
    try {
      ...
      if (_jspx_eval_c_005fforEach_005f0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
        do {
          ...
          out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${productoAdd.nombre}", java.lang.String.class, (PageContext)_jspx_page_context, null, false));
          out.write('"');
          out.write('>');
          out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${productoAdd.nombre}", java.lang.String.class, (PageContext)_jspx_page_context, null, false));
          out.write("</option>\r\n");
  ...
  private boolean _jspx_meth_form_005fform_005f1(PageContext _jspx_page_context)
    ...
    // /WEB-INF/jsp/carrito.jsp(80,5) name = action type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_form_005fform_005f1.setAction("agregarDescuentoAlCarrito");
    // /WEB-INF/jsp/carrito.jsp(80,5) name = method type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_form_005fform_005f1.setMethod("POST");
    // /WEB-INF/jsp/carrito.jsp(80,5) null
    ...
    try {
      ...
      if (_jspx_eval_form_005fform_005f1 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
        do {
          out.write("\r\n");
          out.write("\t\t\t\t\t<div class=\"form-group\">\r\n");
          out.write("\t\t\t\t\t\t<label name=\"nombre\" for=\"nombre\" class=\"col-sm-4 control-label\">Descuento</label>\r\n");
          out.write("\t\t\t\t\t\t<div class=\"col-sm-4\">\r\n");
          out.write("\t\t\t\t\t\t\t<select class=\"form-control\" name=\"nombre\" id=\"nombre\">\r\n");
          out.write("\t\t\t\t\t\t\t\t<option>- Seleccione tipo -</option>\r\n");
          out.write("\t\t\t\t\t\t\t\t<option value=\"Monto\">Monto</option>\r\n");
          out.write("\t\t\t\t\t\t\t\t<option value=\"Porcentaje\">Porcentajeo</option>\r\n");
          out.write("\t\t\t\t\t\t\t</select>\r\n");
          out.write("\t\t\t\t\t\t</div>\r\n");
          out.write("\t\t\t\t\t</div>\r\n");
          out.write("\t\t\t\t\t<div class=\"form-group \" align=\"center\">\r\n");
